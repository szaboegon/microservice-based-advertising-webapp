    ...
    public static ModelBuilder SeedData(this ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Advertisement>().HasData(
            new Advertisement
            {
                ...
                AdvertiserId = 1,
                CategoryId = 1,
                UploadDate = new DateTime(2020, 09, 10)
            },
            new Advertisement
            {
                Id = 2,
                ...
                AdvertiserId = 2,
                CategoryId = 2,
                UploadDate = new DateTime(2021, 12, 10)
            },
            new Advertisement
            {
                Id = 3,
                ...
                AdvertiserId = 1,
                CategoryId = 1,
                UploadDate = new DateTime(2023, 01, 20)
            },
            new Advertisement
            {
                Id = 4,
                ...
                AdvertiserId = 2,
                CategoryId = 3,
                UploadDate = new DateTime(2022, 04, 24)
            },
            new Advertisement
            {
                Id = 5,
                ...
                AdvertiserId = 2,
                CategoryId = 2,
                UploadDate = new DateTime(2021, 10, 12)
            },
            new Advertisement
            {
                Id = 6,
                ...
                AdvertiserId = 1,
                CategoryId = 3,
                UploadDate = new DateTime(2019, 04, 3)
            },
            new Advertisement
            {
                Id = 7,
                ...
                AdvertiserId = 2,
                CategoryId = 3,
                UploadDate = new DateTime(2023, 11, 08)
            },
            new Advertisement
            {
                Id = 8,
                ...
                AdvertiserId = 1,
                CategoryId = 1,
                UploadDate = new DateTime(2022, 10, 30)
            },
            new Advertisement
            {
                Id = 9,
                ...
                AdvertiserId = 2,
                CategoryId = 3,
                UploadDate = new DateTime(2020, 12, 12)
            },
            new Advertisement
            {
                Id = 10,
                ...
                AdvertiserId = 1,
                CategoryId = 3,
                UploadDate = new DateTime(2022, 06, 08)
            },
            new Advertisement
            {
                Id = 11,
                ...
                AdvertiserId = 1,
                CategoryId = 3,
                UploadDate = new DateTime(2023, 07, 14)
            },
            new Advertisement
            {
                Id = 12,
                ...
                AdvertiserId = 2,
                CategoryId = 1,
                UploadDate = new DateTime(2022, 09, 10)
            },
            new Advertisement
            {
                Id = 13,
                ...
                AdvertiserId = 1,
                CategoryId = 3,
                UploadDate = new DateTime(2023, 04, 18)
            },
            new Advertisement
            {
                Id = 14,
                ...
                AdvertiserId = 2,
                CategoryId = 3,
                UploadDate = new DateTime(2021, 08, 08)
            }
        );
