        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    uploadDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 3, 13, 18, 49, 26, 474, DateTimeKind.Local).AddTicks(3129)),
            ...
            migrationBuilder.InsertData(
                table: "Addresses",
                columns: new[] { "id", "city", "district", "postalCode", "region", "streetName", "streetNumber", "unitNumber" },
                values: new object[,]
                {
                    { 1, "Budapest", "XI.", (short)1091, "Pest", "Király utca", "47.", "15." },
                    { 2, "Pécs", null, (short)7600, "Baranya", "Kossuth utca", "12.", "10." }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "id", "addressId", "advertiserId", "categoryId", "description", "furnished", "monthlyPrice", "numberOfRooms", "parking", "size" },
                values: new object[,]
                {
